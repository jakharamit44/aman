...
BOT_TOKEN = environ.get('BOT_TOKEN', '6102515802:AAHbtvGwGtV95e8iEeby4h4XeKin8e7VODE')
...
# Bot Admins
ADMINS = [int(admins) if id_pattern.search(admins) else admins for admins in environ.get('ADMINS', '1864861524').split()]
auth_users = [int(auth_users) if id_pattern.search(auth_users) else auth_users for auth_users in environ.get('AUTH_USERS', '1864861524').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# Channels
INDEX_CHANNELS = [int(index_channels) if id_pattern.search(index_channels) else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1001965720153').split()]
auth_channel = environ.get('AUTH_CHANNEL', '-1001617792393')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001979302999'))
...
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/Mkv_hd_Cinema')
...
SHORTLINK_API = environ.get("SHORTLINK_API", "8be89dca7a5c0099380dbd270790cc2304e7eb70")
